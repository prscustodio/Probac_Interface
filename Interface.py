...
class Ui_Tela(object):
    def setupUi(self, Tela):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 9, 221, 81))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(299, 9, 211, 81))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(579, 9, 191, 81))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 90, 761, 451))
    ...
    def retranslateUi(self, Tela):
        Tela.setWindowTitle(_translate("Tela", "MainWindow", None))
