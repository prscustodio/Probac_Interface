...
class Ui_notepad(object):
    def setupUi(self, notepad):
        ...
        notepad.resize(507, 408)
        self.centralwidget = QtGui.QWidget(notepad)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.horizontalLayoutWidget = QtGui.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 461, 80))
    ...
    def retranslateUi(self, notepad):
        ...
        self.label_2.setText(_translate("notepad", "sirsaijsaidjoajdoiajoidjaiojioajiodjaijdiaosjdoiaj", None))
        self.label.setText(_translate("notepad", "TextLabel", None))
